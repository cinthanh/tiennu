...
<head>
    ...
    <title>@yield('title', 'Management App')</title>
    ...
    <div class="main_container">
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="backend/production/images/img.jpg" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li class="nav-home"><a><i class="fa fa-home"></i> Home <span class="fa
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="backend/production/images/img.jpg" alt="">John Doe
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="dashboard_graph">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h3> <i class="glyphicon glyphicon-fire"></i> @yield('main-title', 'Main Title Page')
                                    {{--<small>Graph title sub-title</small>--}}</h3>
                            </div>
                            <div class="col-md-6">
        ...
        <footer>
            <div class="pull-right">
                Editor by <a href="https://www.facebook.com/thanhdntage">Storm Facebook is here</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
